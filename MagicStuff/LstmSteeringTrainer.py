...
if (sys.argv[3] == "TRUE"):
    net =  NetworkReader.readFrom('LstmSteeringNetwork.xml')
else:
    net = buildNetwork(inputSize, inputSize, outputSize, 
                   hiddenclass=LSTMLayer, outclass = SoftmaxLayer,  outputbias=False, recurrent=True)
...
NetworkWriter.writeToFile(net, 'LstmSteeringNetwork.xml')
